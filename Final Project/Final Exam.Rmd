...
Select model1 to predict the salesPrice on testdata.
...
Model can be improved using Random forest, Decision Tree algorithms. In future  I will work more data cleaning and model building to get optimal prediction. 
